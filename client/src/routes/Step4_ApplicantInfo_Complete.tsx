...
export default function Step4ApplicantInfoComplete() {
  ...
  const form = useForm<Step4FormData>({
    ...
    defaultValues: {
      applicantFirstName: state.step4?.applicantFirstName || "John",
      applicantLastName: state.step4?.applicantLastName || "Smith",
      applicantEmail: state.step4?.applicantEmail || "john.smith@setinc.ca",
      applicantPhone: state.step4?.applicantPhone || "+15878881837",
      applicantAddress: state.step4?.applicantAddress || "PO BOX 20056",
      applicantCity: state.step4?.applicantCity || "Red Deer",
      applicantState: state.step4?.applicantState || "AB",
      applicantZipCode: state.step4?.applicantZipCode || "T4N 6X5",
      applicantDateOfBirth: state.step4?.applicantDateOfBirth || "1980-05-15",

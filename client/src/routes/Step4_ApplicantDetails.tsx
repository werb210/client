...
export default function Step4ApplicantDetails() {
  ...
  const form = useForm<Step4FormData>({
    ...
    defaultValues: {
      firstName: state.step4ApplicantDetails?.firstName || '',
      lastName: state.step4ApplicantDetails?.lastName || '',
      title: state.step4ApplicantDetails?.title || '',
      dateOfBirth: state.step4ApplicantDetails?.dateOfBirth || '',
      socialSecurityNumber: state.step4ApplicantDetails?.socialSecurityNumber || '',
      personalEmail: state.step4ApplicantDetails?.personalEmail || '',
      personalPhone: state.step4ApplicantDetails?.personalPhone || '',
      homeAddress: state.step4ApplicantDetails?.homeAddress || '',
      homeCity: state.step4ApplicantDetails?.homeCity || '',
      homeState: state.step4ApplicantDetails?.homeState || '',
      homeZipCode: state.step4ApplicantDetails?.homeZipCode || '',
      personalIncome: state.step4ApplicantDetails?.personalIncome || '',
      creditScore: state.step4ApplicantDetails?.creditScore || undefined,
      ownershipPercentage: state.step4ApplicantDetails?.ownershipPercentage || '',
      yearsWithBusiness: state.step4ApplicantDetails?.yearsWithBusiness || undefined,
      previousLoans: state.step4ApplicantDetails?.previousLoans || undefined,
      bankruptcyHistory: state.step4ApplicantDetails?.bankruptcyHistory || undefined
    }
  });

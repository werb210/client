...
export const companyProfiles: CompanyProfile[] = [
  ...
  {
    id: 'metro-commercial',
    name: 'Metro Commercial Holdings Ltd.',
    step1: {
      businessLocation: 'CA',
      headquarters: 'CA',
      headquartersState: 'AB',
      ...
      fundsPurpose: 'expansion',
      salesHistory: '3+yr',
      revenueLastYear: 4200000,
      averageMonthlyRevenue: 350000,
      accountsReceivableBalance: 750000,
      fixedAssetsValue: 2500000,
      equipmentValue: 400000,
    },
    step3: {
      operatingName: 'Metro Commercial Holdings',
      legalName: 'Metro Commercial Holdings Ltd.',
      businessStreetAddress: '10180 101 Street NW, Suite 2400',
      businessCity: 'Edmonton',
      businessState: 'AB',
      businessPostalCode: 'T5J 3S4',
      businessPhone: '+17804222400',
      businessWebsite: 'www.metrocommercial.ca',
      businessStartDate: '2016-01-01',
      businessStructure: 'corporation',
      employeeCount: 32,
      estimatedYearlyRevenue: 4500000,
    },
    step4: {
      applicantFirstName: 'James',
      applicantLastName: 'Anderson',
      applicantEmail: 'james.anderson@metrocommercial.ca',
      applicantPhone: '+17804222400',
      applicantAddress: '10180 101 Street NW, Suite 2400',
      applicantCity: 'Edmonton',
      applicantState: 'AB',
      applicantZipCode: 'T5J 3S4',
      applicantDateOfBirth: '1972-12-08',
      ownershipPercentage: 100,
      hasPartner: false,
    },
  },
  {
    id: 'black-label-updated',
    name: '5729841 MB Ltd. o/a Black Label Automation & Electrical (2025)',
    step1: {
      businessLocation: 'CA',
      headquarters: 'CA',
      headquartersState: 'MB',
      ...
      salesHistory: '3+yr',
      revenueLastYear: 9547752,
      averageMonthlyRevenue: 795646,
      accountsReceivableBalance: 30732489,
      fixedAssetsValue: 385891,
      equipmentValue: 385891,
    },
    step3: {
      operatingName: 'Black Label Automation & Electrical',
      legalName: '5729841 MB Ltd.',
    ...
    step4: {
      ...
      applicantEmail: 'michael.kowalski@blacklabelauto.ca',
      applicantPhone: '+12049852225',
      applicantAddress: '30-10 Foxdale Way',
      applicantCity: 'Niverville',
      applicantState: 'MB',
      applicantZipCode: 'R0A 0A1',
      applicantDateOfBirth: '1978-04-22',
      ownershipPercentage: 100,
      hasPartner: false,
    },
  },

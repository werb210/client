      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your business financing applications and track your progress.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white shadow-sm hover:shadow-lg transition-shadow cursor-pointer border border-gray-200 rounded-lg">
            <Link to="/application">
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">New Application</h3>
                <p className="text-gray-600">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Business Term Loan</h3>
                    <p className="text-sm text-gray-600">Application #BF-2024-001 • $150,000</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <span className="px-3 py-1 text-sm font-medium bg-yellow-100 text-yellow-800 rounded-full mr-4">
                    In Review
                  </span>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Application #BF-2024-002 • $100,000</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <span className="px-3 py-1 text-sm font-medium bg-green-100 text-green-800 rounded-full mr-4">
                    Approved
                  </span>
                  <button className="text-blue-600 hover:text-blue-800 font-medium">
                    View Details

...
const Step2RecommendationsFixed = lazy(() => import("@/pages/apply/step-2/Step2_Recommendations"));
...
/* commented route */
      ...
      <Route path="/apply/step-2" component={() => <Suspense fallback={<div>Loading...</div>}><Step2RecommendationsFixed /></Suspense>} />
